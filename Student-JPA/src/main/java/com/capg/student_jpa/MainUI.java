...
public class MainUI {
	...
	public static void main(String[] args) {
		...
		List<Student> studentlist_c1 = new ArrayList<Student>(); // list of students enrolled in course 1
		studentlist_c1.add(student);
		
		List<Student> studentList_c2 = new ArrayList<Student>(); // list of students enrolled in course 2
		studentlist_c1.add(student);
